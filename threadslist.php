...
<body>
    ...
    if($method=='POST'){
      ...
      if( $showAlert){
        echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Success! </strong> Your Thread add successfully! Please wait community respond.
  ...
  <div class="container my-4">
    <div class="jumbotron">
      ...
      <hr class="my-4">
      <p>This is a perr to perr Forum for sharing lnowledge with each other.</p>
      ...
      $row2 = mysqli_fetch_assoc($result2);
        ...
        echo '<div class="media my-3">
              ...
              <div class="media-body">'.
                ...
                '.$desc.'</div>'.'<p class="font-weight-bold my-0"> Asked By <b>'.$row2['user_email'].'</b> At '.$thread_time.'</p>'.'
              </div>';
