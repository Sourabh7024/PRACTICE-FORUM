...
<body>
  ...
  <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <img src="https://source.unsplash.com/2400x700?programers,javascript" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
  ...
  <div class="container my-3" id="ques">
    <h2 class="text-center">AGRI-Discuss |Browse Categories</h2>
    <div class="row">

      <!-- Fetch all the categories -->
      <!-- Use a While loop to iterate through caregories -->
      <?php
          ...
          while($row = mysqli_fetch_assoc($result)){
            ...
            echo '<div class="col-md-4 my-2">
                    <div class="card" style="width: 18rem;">
                      <img src="https://source.unsplash.com/500x400?coding,'.$cat.'" alt="...">
                      <div class="card-body">
